...
from src.dataload_water import DataSet,TetsDataSet
...
def parse_args(argv):
    ...
    parser.add_argument("-e", "--epochs", default=240, type=int, help="Number of epochs")
    parser.add_argument("-lr", "--learning-rate", default=1e-4, type=float, help="Learning rate")
    parser.add_argument("-n", "--num-workers", type=int, default=4, help="Number of dataloader threads")
    parser.add_argument("-q", "--quality-level", type=int, default=22, help="Quality level")
    ...
    parser.add_argument("--checkpoint", type=str, default="pretrained/DMC_slf/222/checkpoint_vd.pth.tar", help="Path to checkpoint")
