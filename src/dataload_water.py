...
class DataSet(data.Dataset):
    ...
    def get_vimeo_frames(self, frame_count):
        ...
        if frame_count < 8:
            return self.get_single_or_multi_frame_vimeo("/home/admin1/Data/water_date_test/water_dataset", "/home/admin1/Data/water_date_test/10_frame.txt", frame_count)
        else:
            return self.get_long_sequence_vimeo("/home/admin1/Data/water_date_test/water_dataset", "/home/admin1/Data/water_date_test/50_frame.txt",frame_count)

    def get_single_or_multi_frame_vimeo(self, rootdir, filefolderlist, frame_count):
        """ General method for getting frames less than 11. (与 get_long_sequence_vimeo 逻辑一致) """
        ...
        for line in data:
            ...
            curnumber = int(y[-7:-4])  # 提取3位帧号 (如 im001.png -> 1)
            ...
            for number in range(1, frame_count):
                input_name = y[0:-7] + str(curnumber + number).zfill(3) + '.png'
